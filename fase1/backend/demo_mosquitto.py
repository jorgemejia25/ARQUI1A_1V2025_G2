...
def demo_complete_system(mode='testing', duration=60):
    ...
    print("   • siepa/sensors (datos completos)")
    print("   • siepa/sensors/temperature")
    print("   • siepa/sensors/humidity") 
    print("   • siepa/sensors/distance")
    print("   • siepa/sensors/light")
    print("   • siepa/sensors/air_quality")
    print("   • siepa/actuators/buzzer (cuando aire malo)")
